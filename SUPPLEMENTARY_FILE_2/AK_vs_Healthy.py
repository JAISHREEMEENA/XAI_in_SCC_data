...
dataset = pd.read_csv("AK_vs_healthy_feature_data.csv")
dataset.head()
...
coeff_df = pd.DataFrame(classifier.coef_.T, X.columns, columns=['Coefficient_AK_vs_Healthy'])


# In[17]:


coeff_df.to_excel('parameters_AK_vs_Healthy.xlsx')
